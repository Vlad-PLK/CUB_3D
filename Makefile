...
#    Updated: 2023/08/07 10:07:57 by mconreau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PROJECT_NAME			:=	cub3d
PROJECT_ARCHIVES		:=	./libraries/libft/libft.a ./libraries/minilibx/mlx42_l.a # << LINUX
#PROJECT_ARCHIVES		:=	./libraries/libft/libft.a ./libraries/minilibx/mlx42_m.a # << MACOS
PROJECT_DEPENDENCIES	:=	./libraries/libft
PROJECT_HEADERS			:=	./headers ./libraries/libft/headers ./libraries/minilibx/headers/MLX42
PROJECT_LIBRARIES		:=	${HOME}/.brew/opt/glfw/lib

# > COMPILATION <<<<<<<<<<

COMPILER_PROGRAM		:=	gcc
COMPILER_PROGRAM_DEBUG	:=	-fsanitize=address,undefined
COMPILER_PROGRAM_FLAGS	:=	-flto -O3 -o
COMPILER_PROGRAM_OTHER	:=	-ldl -lglfw -pthread -lm                                    # << LINUX
#COMPILER_PROGRAM_OTHER	:=	-framework Cocoa -framework OpenGL -framework IOKit -lglfw  # << MACOS
COMPILER_OBJECTS		:=	gcc
COMPILER_OBJECTS_FLAGS	:=	-flto -O3 -g -Wall -Werror -Wextra
...
.PHONY					:	all norm clean debug lclean fclean re
